...
<p class="!text-white !mb-0 text-sm opacity-70">Сегмент 6 · handoff дизайнер ↔ разработчик</p>
...
<h2 class="!text-white !mt-0 !mb-3 text-xl font-bold">Проблема</h2>

<p class="!text-white !mb-3 text-sm opacity-90">Сложные <strong>Reanimated</strong>-взаимодействия:</p>

<ul class="!text-white text-sm space-y-2 list-disc pl-4 m-0">
<li>Сложно описать только в Figma</li>
<li>Разработчики reverse-engineer'ят по видео / статичным кадрам</li>
<li>Медленные итерации, расходящиеся ожидания</li>
</ul>
...
<h2 class="!text-white !mt-0 !mb-3 text-xl font-bold">keyframer.dev</h2>

<p class="!text-white !mb-4 text-sm">Графический редактор → вывод на <strong>Reanimated</strong></p>

<p class="!text-white !mb-2 text-sm font-semibold">Для дизайнеров</p>

<ul class="!text-white text-sm space-y-1 list-disc pl-4 m-0 mb-4">
<li>Timeline / keyframes в духе After Effects</li>
<li><strong>Node graphs</strong> для нетривиальной логики взаимодействий</li>
</ul>

<p class="!text-white !mb-2 text-sm font-semibold">Для разработчиков</p>

<ul class="!text-white text-sm space-y-1 list-disc pl-4 m-0">
<li>Почти готовый animation code при экспорте</li>
<li>Меньше перевода, меньше «это не то, что я имел в виду»</li>
</ul>
...
<h2 class="!text-white !mt-0 !mb-3 text-xl font-bold">Угол бизнес-приложения</h2>

<p class="!text-white !mb-0 text-sm">Onboarding, bottom sheets, guided tours, in-app marketing — motion авторят <strong>вместе с</strong> дизайном, а не после.</p>
...
<h2 class="!text-white !mt-0 !mb-3 text-xl font-bold">Демо · keyframer</h2>

<ol class="!text-white text-sm space-y-2 pl-5 m-0 list-decimal">
<li>Walkthrough редактора (live или запись)</li>
<li>Export → вставка в Expo app</li>
<li>Один интегрированный экран в общем demo app</li>
</ol>
