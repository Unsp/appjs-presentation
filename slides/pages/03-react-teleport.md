...
.rt-menu-teleport {
  opacity: 0;
  animation: rt-menu-pop var(--rt-cycle) ease-in-out infinite;
}
...
@keyframes rt-chat-slide {
  ...
  /* 2. chat opens full screen */
  19%, 44% {
    transform: translateX(0);
    box-shadow: none;
  }
  /* 3. swipe back — list peeks, menu moves with chat */
  52%, 60% {
...
<div class="rt-phone-grid flex flex-col items-center justify-center gap-3 w-full h-full p-4 box-border text-left leading-snug min-h-0 overflow-hidden">

<h2 class="!text-[#34e86a] !mt-0 !mb-0 text-lg font-semibold shrink-0 tracking-tight text-center">✓ Render on top of screen</h2>

<div class="rt-phone-frame relative w-[min(40vw,192px)] shrink-0 aspect-[9/19.5] rounded-[1.75rem] border-[2px] border-[#6a6a6a] bg-[#2a2a2a] p-[5px] shadow-[0_16px_32px_rgba(0,0,0,0.4)]">

<div class="rt-phone-screen relative h-full w-full overflow-hidden rounded-[1.35rem] bg-[#f2f2f2]">
...
<div class="rt-menu-teleport absolute right-2 top-[54px] z-20 w-[102px] overflow-hidden rounded-lg bg-white shadow-[0_8px_20px_rgba(0,0,0,0.16)]">

<div class="flex items-center justify-between border-b border-black/5 px-2.5 py-2 text-[7px] text-black">
<span>View details</span>
<svg class="h-3 w-3 shrink-0 opacity-70" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M3 1h6v10H3z"/><path d="M5 3h2"/></svg>
</div>

<div class="flex items-center justify-between border-b border-black/5 px-2.5 py-2 text-[7px] text-black">
<span>Mute chat</span>
<svg class="h-3 w-3 shrink-0 opacity-70" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M8 2l2 2-6 6-2-2z"/><path d="M2 8l2 2"/></svg>
</div>

<div class="flex items-center justify-between px-2.5 py-2 text-[7px] font-medium text-[#e53935]">
<span>Delete chat</span>
<svg class="h-3 w-3 shrink-0" viewBox="0 0 12 12" fill="none" stroke="#e53935" stroke-width="1.2"><path d="M2 3h8M4 3V2h4v1M3 3l.5 7h5L9 3"/></svg>
</div>
