...
<div class="flex items-center justify-center w-full h-full gap-5 p-6 box-border bg-[#1e1e1e]">

<div class="shrink-0 w-[28%] max-w-xs px-4 py-3 rounded-xl bg-black/55 text-white shadow-2xl">
...
<div class="relative w-full h-full p-3 box-border bg-[#1e1e1e]">
...
<p class="!text-white !mb-3 text-sm opacity-90">2D UI-toolkit от William Candillon — <strong>построен на TypeGPU</strong> и <strong>react-native-webgpu</strong>.</p>
...
Передаём слово → <strong>expo-observe</strong> (партнёр)
...
<!--
Speaker note: конец сегмента 4 → партнёр, expo-observe.
-->
